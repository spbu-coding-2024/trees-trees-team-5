 ...
 */
public class BSTree<K : Comparable<K>, V> : BaseBinaryArithmeticTree<K, V, BSTNode<K, V>, BSTree<K, V>>() {
    /**
    ...
    private fun searchParentNode(node: BSTNode<K, V>?): BSTNode<K, V>? {
        ...
        while (parentNode != null) {
            when {
                ...
                (node.key > parentNode.key && node != parentNode.rightChild) ->
                    parentNode =
